...
// Forward declaration of determineFileType
...
class SignatureFileType {
    // Declare determineFileType as a friend template function
    friend auto determineFileType(const std::string& filename, size_t signatureSize) -> std::string;
...
// Template lambda for determining file type based on signature
auto determineFileType = [](const std::string& filename, size_t signatureSize) -> std::string {
